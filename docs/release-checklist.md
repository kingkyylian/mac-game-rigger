...
- Strict configured Animator smoke is closed for current score >= 3 Unity-pass humanoids, but it is still Generic Animator/controller sampling, not Humanoid Avatar retarget validation.
